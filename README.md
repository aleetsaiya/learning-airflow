...
I also includes a lightweight agent skill [`airflow-project-context`](/.agents/skills/airflow-project-context/SKILL.md). It gives a new AI agent static project context about the Airflow architecture, DAG tasks, local setup, and common troubleshooting notes.
